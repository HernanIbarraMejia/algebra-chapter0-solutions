...
\begin{solution}
	...
	\note{Having thought about it, I'm not sure what he means by that last question.}
\end{solution}
...
\begin{solution}
	...
	% https://q.uiver.app/?q=WzAsNixbMCwwLCJBIl0sWzAsMiwiQiJdLFsxLDEsIlpfMSJdLFszLDAsIkEiXSxbMywyLCJCIl0sWzQsMSwiWl8yIl0sWzAsMiwiZl8xIl0sWzEsMiwiZ18xIiwyXSxbMyw1LCJmXzIiXSxbNCw1LCJnXzIiLDJdXQ==
	\[\begin{tikzcd}[column sep=2.25em,row sep=tiny]
		A &&& A \\
		& {Z_1} &&& {Z_2} \\
		B &&& B
	...
	Given two objects 
	% https://q.uiver.app/?q=
	\[\begin{tikzcd}[column sep=2.25em,row sep=tiny]
		& A &&& A \\
		C && {Z_1} & C && {Z_2} \\
		& B &&& B
		...
		\arrow["{g_1}"', from=3-2, to=2-3]
		\arrow["\alpha", from=2-4, to=1-5]
		\arrow["\beta"', from=2-4, to=3-5]
		\arrow["{f_2}", from=1-5, to=2-6]
		\arrow["{g_2}"', from=3-5, to=2-6]
	\end{tikzcd},\]
	a morphism between from the leftmost one to the other one is a commutative diagram of the form 
	% https://q.uiver.app/?q=WzAsNSxbMSwyLCJCIl0sWzEsMCwiQSJdLFswLDEsIkMiXSxbMiwxLCJaXzEiXSxbMywxLCJaXzIiXSxbMiwxLCJcXGFscGhhIl0sWzIsMCwiXFxiZXRhIiwyXSxbMSwzLCJmXzEiXSxbMCwzLCJnXzEiLDJdLFsxLDQsImZfMiIsMCx7ImN1cnZlIjotMn1dLFswLDQsImdfMiIsMix7ImN1cnZlIjoyfV0sWzMsNCwiXFxzaWdtYSJdXQ==
	\[\begin{tikzcd}[column sep=2.25em,row sep=tiny]
		& A \\
		C && {Z_1} & {Z_2} \\
		& B
		...
		\arrow["{f_1}", from=1-2, to=2-3]
		\arrow["{g_1}"', from=3-2, to=2-3]
		\arrow["{f_2}", curve={height=-12pt}, from=1-2, to=2-4]
		\arrow["{g_2}"', curve={height=12pt}, from=3-2, to=2-4]
		\arrow["\sigma", from=2-3, to=2-4]
	\end{tikzcd},\]
	where $\sigma\in \Hom_{\srf{C}}(Z_1,Z_2)$. Given two morphisms
	% https://q.uiver.app/?q=
	\[\begin{tikzcd}[column sep=2.25em,row sep=tiny]
		& A &&&& A \\
		C && {Z_1} & {Z_2} & C && {Z_2} & {Z_3} \\
		& B &&&& B
		...
		\arrow["{g_2}"', curve={height=12pt}, from=3-2, to=2-4]
		\arrow["\sigma", from=2-3, to=2-4]
		\arrow["{f_2}", from=1-6, to=2-7]
		\arrow["{g_2}"', from=3-6, to=2-7]
		\arrow["{f_3}", curve={height=-12pt}, from=1-6, to=2-8]
		\arrow["\alpha", from=2-5, to=1-6]
		\arrow["\beta"', from=2-5, to=3-6]
		\arrow["{g_3}"', curve={height=12pt}, from=3-6, to=2-8]
		\arrow["\tau", from=2-7, to=2-8]
	\end{tikzcd},\]
	we can compose them as follows. First, combine them as depicted below.
	% https://q.uiver.app/?q=
	\[\begin{tikzcd}[column sep=2.25em,row sep=tiny]
		& A \\
		C && {Z_1} & {Z_2} & {Z_3} \\
		& B
		...
		\arrow["{f_1}", from=1-2, to=2-3]
		\arrow["{g_1}"', from=3-2, to=2-3]
		\arrow["{f_2}"{pos=0.7}, curve={height=-12pt}, from=1-2, to=2-4]
		\arrow["{g_2}"'{pos=0.7}, curve={height=12pt}, from=3-2, to=2-4]
		\arrow["\sigma", from=2-3, to=2-4]
		\arrow["\tau", from=2-4, to=2-5]
		\arrow["{f_3}", curve={height=-24pt}, from=1-2, to=2-5]
		\arrow["{g_3}"', curve={height=24pt}, from=3-2, to=2-5]
	\end{tikzcd}\]
	The resulting diagram is seen to be commutative. In particular, it is commutative when we remove the middle object, $Z_2$.
	
	% https://q.uiver.app/?q=
	\[\begin{tikzcd}[column sep=2.25em,row sep=tiny]
		& A \\
		C && {Z_1} & {Z_3} \\
		& B
		...
		\arrow["{f_1}", from=1-2, to=2-3]
		\arrow["{g_1}"', from=3-2, to=2-3]
		\arrow["{f_3}", curve={height=-12pt}, from=1-2, to=2-4]
		\arrow["{g_2}"', curve={height=12pt}, from=3-2, to=2-4]
		\arrow["\tau\sigma", from=2-3, to=2-4]
	\end{tikzcd}.\]
	Identities in this category are morphisms of the form
	% https://q.uiver.app/?q=WzAsNSxbMSwyLCJCIl0sWzEsMCwiQSJdLFswLDEsIkMiXSxbMiwxLCJaIl0sWzMsMSwiWiJdLFsyLDEsIlxcYWxwaGEiXSxbMiwwLCJcXGJldGEiLDJdLFsxLDMsImYiXSxbMCwzLCJnIiwyXSxbMSw0LCJmIiwwLHsiY3VydmUiOi0yfV0sWzAsNCwiZyIsMix7ImN1cnZlIjoyfV0sWzMsNCwiMV9aIl1d
	\[\begin{tikzcd}[column sep=2.25em,row sep=tiny]
		& A \\
		C && Z & Z \\
		& B
